...
namespace TheRiptide
{
    public class DeathmatchMenu
    {
        ...
        {
            InventoryMenu.CreateMenu((int)MenuPage.None, "",
            [
                new(ItemType.KeycardO5, "", (player)=>
                {
            ...
            InventoryMenu.CreateMenu((int)MenuPage.Main, translation.MainMenu,
            [
                new(ItemType.KeycardO5, translation.SaveAndExit, (player)=>
                {
                ...
                new(ItemType.KeycardScientist, translation.CustomiseLoadout, (player)=>
                {
                ...
                new(ItemType.KeycardResearchCoordinator, translation.KillstreakRewardSystem, (player)=>
                {
                    Killstreaks.Killstreak killstreak = Killstreaks.GetKillstreak(player);
                    Loadouts.Loadout loadout = Loadouts.GetLoadout(player);
                    MenuInfo info;
                ...
                new(ItemType.KeycardContainmentEngineer, translation.Role, (player)=>
                {
                    InventoryMenu.ShowMenu(player, (int)MenuPage.Role);
                    return false;
                }),
                new(ItemType.KeycardFacilityManager, translation.Preferences, (player)=>
                {
            ...
            InventoryMenu.CreateMenu((int)MenuPage.GunSlot1, translation.GunSlotMenu,
            [
                new(ItemType.KeycardO5, translation.BackToMainMenu, (player)=>
                {
                    InventoryMenu.ShowMenu(player, (int)MenuPage.Main);
                    return false;
                }),
                new(ItemType.KeycardFacilityManager, translation.Primary, (player)=>
                {
            ...
            InventoryMenu.CreateMenu((int)MenuPage.GunSlot2, translation.GunSlotMenu,
            [
                new(ItemType.KeycardO5, translation.BackToMainMenu, (player)=>
                {
                    InventoryMenu.ShowMenu(player, (int)MenuPage.Main);
                ...
                new(ItemType.KeycardZoneManager, translation.Secondary, (player)=>
                {
            ...
            InventoryMenu.CreateMenu((int)MenuPage.GunSlot3, translation.GunSlotMenu,
            [
                new(ItemType.KeycardO5, translation.BackToMainMenu, (player)=>
                {
                    InventoryMenu.ShowMenu(player, (int)MenuPage.Main);
                ...
                new(ItemType.KeycardMTFCaptain, translation.HeavyPrimary, (player)=>
                {
                    Loadouts.GetLoadout(player).slot = Loadouts.GunSlot.Primary;
                    InventoryMenu.ShowMenu(player, (int)MenuPage.GunClass);
                    return false;
                }),
                new(ItemType.KeycardMTFOperative, translation.HeavySecondary, (player)=>
                {
                    Loadouts.GetLoadout(player).slot = Loadouts.GunSlot.Secondary;
                    InventoryMenu.ShowMenu(player, (int)MenuPage.GunClass);
                    return false;
                }),
                new(ItemType.KeycardMTFPrivate, translation.HeavyTertiary, (player)=>
                {
            ...
            InventoryMenu.CreateMenu((int)MenuPage.GunClass, translation.GunClassMenu,
            [
                new(ItemType.KeycardO5, translation.BackToMainMenu, (player)=>
                {
                    InventoryMenu.ShowMenu(player, (int)MenuPage.Main);
                ...
                new(ItemType.KeycardMTFCaptain, translation.MtfGuns, (player)=>
                {
                    InventoryMenu.ShowMenu(player, (int)MenuPage.MtfGun);
                    return false;
                }),
                new(ItemType.KeycardChaosInsurgency, translation.ChaosGuns, (player)=>
                {
            ...
            InventoryMenu.CreateMenu((int)MenuPage.MtfGun, translation.MtfGunMenu,
            [
                new(ItemType.KeycardO5, translation.BackToMainMenu, (player)=>
                {
                    InventoryMenu.ShowMenu(player, (int)MenuPage.Main);
                ...
                new(ItemType.GunCOM15, "", (player)=> { return GunSelected(player, ItemType.GunCOM15); }),
                new(ItemType.GunCOM18, "", (player)=> { return GunSelected(player, ItemType.GunCOM18);  }),
                new(ItemType.GunFSP9, "", (player)=> { return GunSelected(player, ItemType.GunFSP9);  }),
                new(ItemType.GunCrossvec, "", (player)=> { return GunSelected(player, ItemType.GunCrossvec); }),
                new(ItemType.GunE11SR, "", (player)=> { return GunSelected(player, ItemType.GunE11SR);  }),
                new(ItemType.GunFRMG0, "", (player)=> { return GunSelected(player, ItemType.GunFRMG0);  })
            ]);

            InventoryMenu.CreateMenu((int)MenuPage.ChaosGun, translation.ChaosGunMenu,
            [
                new(ItemType.KeycardO5, translation.BackToMainMenu, (player)=>
                {
                    InventoryMenu.ShowMenu(player, (int)MenuPage.Main);
                ...
                new(ItemType.GunAK, "", (player)=> { GunSelected(player, ItemType.GunAK); return false; }),
                new(ItemType.GunLogicer, "", (player)=> { GunSelected(player, ItemType.GunLogicer); return false; }),
                new(ItemType.GunShotgun, "", (player)=> { GunSelected(player, ItemType.GunShotgun); return false; }),
                new(ItemType.GunRevolver, "", (player)=> { GunSelected(player, ItemType.GunRevolver); return false; }),
                new(ItemType.GunA7, "", (player)=> { GunSelected(player, ItemType.GunA7); return false;  })
            ]);

            List<MenuItem> killstreak_items =
            [
            ...
            List<MenuItem> killstreak_items_secret = [.. killstreak_items];
            ...
            InventoryMenu.CreateMenu((int)MenuPage.Role, translation.RoleMenu,
            [
                new(ItemType.KeycardO5, translation.BackToMainMenu, (player)=>
                {
                    InventoryMenu.ShowMenu(player, (int)MenuPage.Main);
                ...
                new(ItemType.KeycardJanitor, translation.ClassD, (player)=>
                {
                    return RoleSelected(player, RoleTypeId.ClassD);
                }),
                new(ItemType.KeycardScientist, translation.Scientist, (player)=>
                {
                    return RoleSelected(player, RoleTypeId.Scientist);
                }),
                new(ItemType.KeycardGuard, translation.Guard, (player)=>
                {
                    return RoleSelected(player, RoleTypeId.FacilityGuard);
                }),
                new(ItemType.KeycardMTFPrivate, translation.Private, (player)=>
                {
                    return RoleSelected(player, RoleTypeId.NtfPrivate);
                }),
                new(ItemType.KeycardMTFOperative, translation.Sergeant, (player)=>
                {
                    return RoleSelected(player, RoleTypeId.NtfSergeant);
                }),
                new(ItemType.KeycardMTFCaptain, translation.Captain, (player)=>
                {
                    return RoleSelected(player, RoleTypeId.NtfCaptain);
                }),
                new(ItemType.KeycardChaosInsurgency, translation.Chaos, (player)=>
                {
                    return RoleSelected(player, RoleTypeId.ChaosConscript);
                })
            ]);

            InventoryMenu.CreateMenu((int)MenuPage.Preference, translation.PreferencesMenu,
            [
                new(ItemType.KeycardO5, translation.BackToMainMenu, (player)=>
                {
                    InventoryMenu.ShowMenu(player, (int)MenuPage.Main);
                ...
                new(ItemType.KeycardScientist, translation.Stats, (player)=>
                {
                ...
                new(ItemType.Flashlight, translation.Spectator, (player)=>
                {
                    Lobby.Singleton.SetSpectatorMode(player, true);
                    return false;
                }),
                new(ItemType.Coin, translation.EnableRage, (player)=>
                {
                    Loadouts.GetLoadout(player).rage_mode_enabled = true;
                    InventoryMenu.ShowMenu(player, (int)MenuPage.Main);
                    return false;
                }),
                new(ItemType.KeycardJanitor, translation.DeleteData, (player)=>
                {
                    InventoryMenu.ShowMenu(player, (int)MenuPage.DeleteData);
                    return false;
                }),
                new(ItemType.SCP1576, translation.LeaderBoard, (player)=>
                {
            ...
            InventoryMenu.CreateMenu((int)MenuPage.Stats, translation.StatsMenu,
            [
                new(ItemType.KeycardO5, translation.BackToPreferences, (player)=>
                {
            ...
            InventoryMenu.CreateMenu((int)MenuPage.DeleteData, translation.DeleteDataMenu,
            [
                new(ItemType.KeycardO5, translation.BackToPreferences, (player)=>
                {
                    BroadcastOverride.ClearLines(player, BroadcastPriority.Highest);
                ...
                new(ItemType.KeycardJanitor, translation.AreYouSure, (player)=>
                {
            ...
            InventoryMenu.CreateMenu((int)MenuPage.LeaderBoard, translation.LeaderBoardMenu,
            [
                new(ItemType.KeycardO5, translation.BackToPreferences, (player)=>
                {
                    BroadcastOverride.ClearLines(player, BroadcastPriority.Highest);
            ...
            InventoryMenu.CreateMenu((int)MenuPage.Debug, "<b><color=#43BFF0>[DEBUG]</color></b> - <b><color=#FF0000>RIGHT CLICK TO SELECT</color></b>",
            [
                new(ItemType.KeycardO5, "<color=#5900ff>[O5]</color> = <b>Back to <color=#43BFF0>[MAIN MENU]</color></b>", (player)=>
                {
                    InventoryMenu.ShowMenu(player, (int)MenuPage.Main);
                    return false;
                }),
                new(ItemType.KeycardGuard, "close all rooms", (player)=>
                {
                    BroadcastOverride.BroadcastLine(player, 7, 3.0f, BroadcastPriority.High, "closed all rooms");
                    //Rooms.LockdownFacility();
                    return false;
                }),
                new(ItemType.KeycardMTFPrivate, "open all rooms", (player)=>
                {
                    BroadcastOverride.BroadcastLine(player, 7, 3.0f, BroadcastPriority.High, "opened all rooms");
                    //Rooms.UnlockFacility();
                    return false;
                }),
                new(ItemType.KeycardMTFOperative, "start game", (player)=>
                {
                ...
                new(ItemType.KeycardMTFCaptain, "end game", (player)=>
                {
